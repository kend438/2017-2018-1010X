...
// defines for direction. not required, but make code reading easier
#define FORWARD 1
#define BACKWARDS -1
#define CLOCKWISE 1
#define COUNTERCLOCKWISE -1

// defines for arm position (used in updating arm_target in autonomous)
#define ARM_GROUND 0
#define ARM_LOW 200
...
// defines for claw position (used in updating claw_target in autonomous)
...
// function delcarations - see autofunctions.c for function descriptions
