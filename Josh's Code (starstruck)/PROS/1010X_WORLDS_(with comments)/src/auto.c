...
#define DUMP_HIEGHT 600 // for old autos
void autonomous() {
...
//slew set // ALL FALSE for debugging (worlds fix)
...
// switch case for all autonomouses (select using lcd when robot disabled)
switch (myauto) {
case -2: // MOTOR TEST // not tested, removed for worlds
/*
  delay(5);
...
case -1: //Blank  - For testing functions/code
delay(1000);
